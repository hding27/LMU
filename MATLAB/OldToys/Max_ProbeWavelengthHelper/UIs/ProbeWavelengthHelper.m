...
% Last Modified by GUIDE v2.5 24-Feb-2017 11:19:11
...
% --- Executes on key press with focus on pOpen and none of its controls.
function pOpen_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to pOpen (see GCBO)
