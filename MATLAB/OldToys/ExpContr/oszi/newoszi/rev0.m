...
% Last Modified by GUIDE v2.5 04-Nov-2011 17:41:03
...
get_data(handles,0,filename)



function get_data(handles, numb, filename)
global deviceObj;
    ...
    if (get(handles.checkbox2,'Value'))
        ...
        if savevar
            dlmwrite([filename,'_CH2_',num2str(numb)],[x',y']);
        end
    ...
    if (get(handles.checkbox3,'Value'))
        ...
        if savevar
            dlmwrite([filename,'_CH3_',num2str(numb)],[x',y']);
        end
    end
    ...
    if (get(handles.checkbox4,'Value'))
        ...
        if savevar
            dlmwrite([filename,'_CH4_',num2str(numb)],[x',y']);
        end
    end 
    
drawnow;

function get_data_wo_xplot(handles, numb, filename)
global deviceObj;
    
    filename = [filename,'_',num2str(numb),'_FASTFRAME'];
    ...
    if (get(handles.checkbox2,'Value'))
        ...
        if savevar
            dlmwrite([filename,'_Xaxis'],[x']);
            dlmwrite([filename,'_CH2'],[y']);
        end
    ...
    if (get(handles.checkbox3,'Value'))
        [y, x, yUnit, xUnit] = invoke(groupObj, 'readwaveform', 'channel3',1);
        plot(handles.axes3,y,'r');
        if savevar
            dlmwrite([filename,'_Xaxis'],[x']);
            dlmwrite([filename,'_CH3'],[y']);
        end
    end
    
    if (get(handles.checkbox4,'Value'))
        [y, x, yUnit, xUnit] = invoke(groupObj, 'readwaveform', 'channel4',1);
        plot(handles.axes4,y,'g');
        if savevar
            dlmwrite([filename,'_Xaxis'],[x']);
            dlmwrite([filename,'_CH4'],[y']);
        end
    end 
...
set(deviceObj.Acquisition(1), 'State', 'run');
bljied = get(deviceObj.Acquisition(1), 'AcquisitionCount')
filename = fullfile(get(handles.savefolder_button,'String'),...
    get(handles.filename_edit,'String'));
while (~mstop)
...
function reclength_edit_Callback(hObject, eventdata, handles)
% hObject    handle to reclength_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of reclength_edit as text
%        str2double(get(hObject,'String')) returns contents of reclength_edit as a double


% --- Executes during object creation, after setting all properties.
function reclength_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to reclength_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function framecount_edit_Callback(hObject, eventdata, handles)
% hObject    handle to framecount_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of framecount_edit as text
%        str2double(get(hObject,'String')) returns contents of framecount_edit as a double


% --- Executes during object creation, after setting all properties.
function framecount_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to framecount_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in fastframe_button.
function fastframe_button_Callback(hObject, eventdata, handles)
% hObject    handle to fastframe_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global deviceObj;
interface = get(deviceObj,'interface');

reclength = str2num(get(handles.reclength_edit,'String'));
fprintf(interface, ['horizontal:fastframe:length ' num2str(reclength)]);

framecount = str2num(get(handles.framecount_edit,'String'));
fprintf(interface, ['horizontal:fastframe:count ' num2str(framecount)]);

setframeco = query(interface,'HORizontal:Fastframe:count?');
set(handles.framecount_edit,'String',setframeco(1:end-1));
setreclen = query(interface,'HORizontal:Fastframe:length?');
set(handles.reclength_edit,'String',setreclen(1:end-1));
...
filename = fullfile(get(handles.savefolder_button,'String'),...
 ...
 while (get(deviceObj.Acquisition(1), 'AcquisitionCount') < setframeco)
     pause(1);
 end
 
 n = str2num(get(handles.fastframen_edit,'String'));
 get_data_wo_xplot(handles,n,filename);
 



function fastframen_edit_Callback(hObject, eventdata, handles)
% hObject    handle to fastframen_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of fastframen_edit as text
%        str2double(get(hObject,'String')) returns contents of fastframen_edit as a double


% --- Executes during object creation, after setting all properties.
function fastframen_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to fastframen_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
