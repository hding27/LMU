function varargout = rev3(varargin)
% REV3 M-file for rev3.fig
%      REV3, by itself, creates a new REV3 or raises the existing
%      singleton*.
%
%      H = REV3 returns the handle to a new REV3 or the handle to
%      the existing singleton*.
%
%      REV3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in REV3.M with the given input arguments.
%
%      REV3('Property','Value',...) creates a new REV3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before rev3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to rev3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help rev3

% Last Modified by GUIDE v2.5 23-Nov-2010 13:39:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @rev3_OpeningFcn, ...
                   'gui_OutputFcn',  @rev3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before rev3 is made visible.
function rev3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to rev3 (see VARARGIN)

% Choose default command line output for rev3
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes rev3 wait for user response (see UIRESUME)
...
function varargout = rev3_OutputFcn(hObject, eventdata, handles) 
