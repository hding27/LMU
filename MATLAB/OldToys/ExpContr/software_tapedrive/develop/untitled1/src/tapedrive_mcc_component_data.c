...
extern "C" {
#endif
const unsigned char __MCC_tapedrive_session_key[] = {
        '0', '1', '8', '4', '8', '4', '6', '8', 'B', 'F', '2', 'B', 'B', '0',
        '2', '8', 'B', '4', '6', '5', 'A', '3', '4', 'E', '0', 'D', '0', '6',
        '4', 'A', 'A', 'A', '8', '5', 'F', 'A', 'E', 'E', '8', 'D', '2', 'E',
        'F', '2', '9', '0', '9', '4', '4', '0', 'B', 'C', 'C', 'B', 'A', 'C',
        '2', '4', '7', '3', '1', 'D', '5', '3', 'B', '6', '7', '0', 'E', 'A',
        '5', '8', 'E', 'F', '3', '3', 'C', '8', '9', '1', '1', 'B', '6', '0',
        'B', 'D', '7', '4', '9', '8', '2', '9', 'B', 'F', '3', '2', '2', '0',
        'D', 'E', '9', '4', '9', 'D', 'B', '7', 'F', 'C', 'D', '4', 'E', 'E',
        '2', '7', 'C', 'A', 'C', '2', '8', '1', '7', 'A', 'A', 'C', 'B', '4',
        '5', '6', '5', 'E', '7', '8', '9', 'A', '4', '0', 'F', '1', 'C', '2',
        'D', '7', '2', '8', '3', '1', 'A', '4', '2', '5', '9', '2', 'B', '0',
        '6', 'F', 'B', '3', 'A', '6', '8', 'C', '9', 'F', 'D', 'E', '2', '3',
        'A', 'E', '2', '6', 'D', 'F', '2', 'D', '0', 'D', 'D', '6', '3', 'B',
        'C', 'F', 'C', 'F', '3', '6', '3', '8', '5', 'E', '0', '2', '5', '9',
        '3', '1', '8', 'B', '7', '5', '6', 'A', 'B', '1', '0', '7', 'A', 'B',
        'C', 'A', 'B', '4', '7', 'E', 'A', '7', '7', '0', '7', '8', 'A', '6',
        '1', '3', '9', 'C', '9', '9', 'B', '5', '9', '9', '5', '4', '7', '7',
        '8', '2', '0', '6', '8', '8', 'A', 'C', '1', '3', '7', 'E', '4', '3',
        '0', '6', '4', '5', '\0'};

const unsigned char __MCC_tapedrive_public_key[] = {
...
static const char * MCC_tapedrive_matlabpath_data[] = 
    { "tapedrive/", "toolbox/compiler/deploy/", "$TOOLBOXMATLABDIR/general/",
...
static const char * MCC_tapedrive_classpath_data[] = 
    { "" };

static const char * MCC_tapedrive_libpath_data[] = 
    { "" };

static const char * MCC_tapedrive_app_opts_data[] = 
    { "" };

static const char * MCC_tapedrive_run_opts_data[] = 
    { "" };

static const char * MCC_tapedrive_warning_state_data[] = 
    { "off:MATLAB:dispatcher:nameConflict" };


mclComponentData __MCC_tapedrive_component_data = { 

    /* Public key data */
    __MCC_tapedrive_public_key,
    ...
    __MCC_tapedrive_session_key,

    /* Component's MATLAB Path */
    MCC_tapedrive_matlabpath_data,

    /* Number of directories in the MATLAB Path */
    36,

    /* Component's Java class path */
    MCC_tapedrive_classpath_data,
    /* Number of directories in the Java class path */
    0,

    /* Component's load library path (for extra shared libraries) */
    MCC_tapedrive_libpath_data,
    /* Number of directories in the load library path */
    0,

    /* MCR instance-specific runtime options */
    MCC_tapedrive_app_opts_data,
    /* Number of MCR instance-specific runtime options */
    0,

    /* MCR global runtime options */
    MCC_tapedrive_run_opts_data,
    /* Number of MCR global runtime options */
    0,
    
    /* Component preferences directory */
    "tapedrive_CD73FD900DEF374A8D57A03CA981405F",

    /* MCR warning status data */
    MCC_tapedrive_warning_state_data,
