function [error_code] = pfSTART_CAMERA(board_handle)
...
% or starting new exposures.
% A new exposure can be released with pfSTART_CAMERA and a hardware or a
% software trigger. pixelfly SDK manual p.8.
...
if nargin ~= 1
    error('...wrong number of arguments have been passed to pfSTART_CAMERA, see help!')
end
...
error_code =  calllib('PCO_PF_SDK', 'START_CAMERA', board_handle);
