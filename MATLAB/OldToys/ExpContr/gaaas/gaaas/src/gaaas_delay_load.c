 ...
 */
FARPROC WINAPI gaaasDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = gaaasDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = gaaasDelayLoadWin32FailureHook;
#endif
