function GET_SEQ16_VIDEO(board_number,nr_of_images)
% GET_SEQ16_ASYNC();
...
error_code=pfSETMODE(board_handle,hex2dec('31'),50,exptime,0,0,0,0,12,0);
if(error_code~=0) 
...
if(comment)
 disp('call pfTRIGGER_CAMERA, trigger the camera to start image sequence');
end
