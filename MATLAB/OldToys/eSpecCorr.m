%% pointing imaging calibration, define the pointing
...
%
%%
%  spectrometer imaging calibration, define the intersection points in the 
...
%% roate the image such that energy axis is horizontal
...
for ii=1:N
    ...
    fun = @(E) eTrajectory(E,0,0,'LE')-Z(ii); % see help in eTrajectory
