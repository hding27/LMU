function varargout = rearmark_v2(varargin)
% version 02-06-2011

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @rearmark_v2_OpeningFcn, ...
                   'gui_OutputFcn',  @rearmark_v2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function rearmark_v2_OpeningFcn(hObject, eventdata, handles, varargin)
...
% open PVs
handles.img     = mcacheckopen('EDAQ:CAM:BEAST:REAR:WVF');
...
% install monitors
mcamon(handles.img,'rearmark_update_v2');
...
function varargout = rearmark_v2_OutputFcn(hObject, eventdata, handles) 
